...
// pub struct DynRequestBodyLimitLayer {
//     limit: &'static mut usize,
// }

// impl DynRequestBodyLimitLayer {
//     /// Create a new `RequestBodyLimitLayer` with the given body length limit.
//     pub fn new(limit: &'static mut usize) -> Self {
//         Self { limit }
//     }
// }

// impl <S>Layer<S> for DynRequestBodyLimitLayer {
//     fn layer(&self, inner: S) -> Self::Service {
//         DynRequestBodyLimitLayer {
//             inner,
//             limit: self.limit
//         }
//     }
